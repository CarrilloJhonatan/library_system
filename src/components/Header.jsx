import {
  ...
  const Header = () => {
    return (
      <header className="h-[7vh] md:h-[10vh] color-secundario border-b border-secondary-100 p-8 flex drop-shadow-md items-center justify-end">
        <nav className="flex items-center gap-2">
          ...
          >
            ...
            <MenuItem className="p-0 hover:bg-transparent">
              <Link
                to="/"
                className="text-gray-700 flex flex-1 items-center gap-4 py-2 px-4 hover:bg-secondary-900 transition-colors rounded-lg"
              >
                <img
                ...
                <div className="text-sm flex flex-col">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <span className="text-[8px] tex">21/10/2022</span>
                  </div>
            ...
            <MenuItem className="p-0 hover:bg-transparent">
              ...
              >
                ...
                <div className="flex flex-col text-sm">
                  <span className="text-sm">Luis Fernando</span>
                  <span className="text-xs text-gray-500">fernado@gmail.com</span>
                </div>
              </Link>
            </MenuItem>
